from PyQt6.QtWidgets import QApplication, QVBoxLayout, QLabel, QWidget, QGridLayout, \
    QLineEdit, QMainWindow, QTableWidget, QTableWidgetItem, QDialog, QVBoxLayout, \
    QComboBox, QPushButton, QToolBar, QStatusBar, QMessageBox
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Create toolbar and create toolbar element
        toolbar = QToolBar()
...
class AboutDialog(QMessageBox):
    def __init__(self):
        ...
        content = """
        This app was created during the practice purpose while learning python.
...
class DeleteDialog(QDialog):
    ...
    def delete_student(self):
        # Get selected student id and index
        index = main_window.table.currentRow()
